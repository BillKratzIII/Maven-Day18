...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "projectthree";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "projectthree.war")
            ...
            .addPackages(false, "com.projectthree") // not recursive to skip package 'nonarquillian'
